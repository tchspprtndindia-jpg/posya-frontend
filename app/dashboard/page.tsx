                            ...
                            <td className="px-3 py-2">
                              <div className="flex flex-row gap-2 items-center">
                                <div className="relative group">
                                  ...
                                  <span className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all bg-[#0d3b2e] text-white text-xs px-3 py-1 rounded-lg shadow-lg whitespace-nowrap font-medium">
                                    Download Invoice
                                  </span>
                                </div>
